...
### немного оптимизировал код, вынес часто используемые процедуры в отдельные именованные
def stat_key (email = valid_email, password = valid_password):
    """ процедура авторизации ... чтоб сто раз не писать эту строчку """
...
def all_my_pets ():
    """ получение списка своих питомцев и ID последнего добавленного своего питомца - тоже часто необходимо """
